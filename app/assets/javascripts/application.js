...
(function($) {
    ...
    $(function() {
        ...
        // add child or subsection if the link has a dropdown inside
        $('nav ul li a:not(:only-child)').click(function(e) {
            $(this).siblings('.navigation-dropdown').toggle();
            // hide the other dropdown when open another
        ...
        // onClick function to open the nav
        $('#navigation-toggle').click(function() {
            $('nav ul').slideToggle();
        });

        // change the menu to x
