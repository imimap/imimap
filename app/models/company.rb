class Company < ActiveRecord::Base
  attr_accessible :street, :city, :country, :zip, :main_language, :department, :industry, :name, :number_employees, :website, :phone, :blacklisted, :fax, :import_id, :latitude, :longitude
