...
docker-compose -f docker-compose-production.yml exec imimap rails db:migrate:status
echo "+++++ Database Migration"
docker-compose -f docker-compose-production.yml exec imimap rails db:migrate
exit_on_error $?
