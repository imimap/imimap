...
<<<<<<< HEAD
ActiveRecord::Schema.define(version: 20_170_902_214_206) do
  ...
  create_table 'internships_programming_languages', id: false, force: :cascade do |t|
    ...
    t.integer 'internship_id'
    t.index %w[programming_language_id internship_id], name: 'unique_index', unique: true
  end
...
=======
ActiveRecord::Schema.define(version: 20180326213706) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.index ["email"], name: "index_users_on_email", unique: true
    t.index ["reset_password_token"], name: "index_users_on_reset_password_token", unique: true
>>>>>>> uncommitted changes from st bachelor's thesis
  end
end
