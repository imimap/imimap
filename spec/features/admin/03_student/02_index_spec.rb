...
describe 'ActiveAdmin Student / Index' do
  context '(logged in)' do
    ...
    it 'shows students details headers' do
      ...
      expect(page).to have_content t('activerecord.attributes.student.first_name')
      expect(page).to have_content t('activerecord.attributes.student.last_name')
    ...
    it 'has link to Student' do
      ...
      expect(current_path).to eq admin_student_path(id: @student, locale: I18n.locale)
    end
